...
contract RaffleTest is Test, CodeConstants {
    ...
    function testFulfillrandomWordsCanOnlyEnteredAfterPerformUpkeep(
        ...
        skipFork
    {
        ...
        Vm.Log[] memory entries = vm.getRecordedLogs();
        bytes32 requestId = entries[1].topics[1];
        console.log("vrfCoordinator function starts");
        VRFCoordinatorV2_5Mock(vrfCoordinator).fulfillRandomWords(
            uint256(requestId),
            address(raffle)
        );
        console.log("vrfCoordinator function finished");
